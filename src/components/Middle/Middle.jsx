...
const Middle=({play, togglePlay})=>{
    ...
    const TopbarButton=({icon})=>{
        return(
            <IconButton style={{ background:colors.gray[800]}}>
                {icon}
            </IconButton>
        )
    }
            ...
            <Box sx={subBox}>
                <Box sx={topBar}>
                    <Box display="flex" gap="8px">
                        <TopbarButton icon={<HiOutlineChevronLeft size="20px" color={colors.gray[100]}/>}/>
                        <TopbarButton icon={<HiOutlineChevronRight size="20px" color={colors.gray[100]}/>}/>
                    </Box>
                    <Box display="flex" gap="8px">
                        ...
                        <IconButton style={{ background:colors.gray[800]}}>
                            <HiOutlineUserGroup size="20px" color={colors.gray[100]}/>
                        </IconButton>
                        <IconButton onClick={colorMode.toggleColorMode} style={{ background:colors.gray[800]}}>
                            {theme.palette.mode==="dark" ? (
                                <HiOutlineMoon size="20px" color={colors.gray[100]}/>
                            ):(
                                <HiOutlineSun size="20px" color={colors.gray[100]}/>
                            )}
                        </IconButton>
                ...
                <Box overflow="auto">
                    <List disablePadding sx={{ background:colors.gray[900]}}>
                        ...
                        <Box display="flex" flexDirection="column"  bgcolor={colors.gray[900]} >
                            <Box display="flex" justifyContent="space-between">
                                <Box display="flex" alignItems="center">
                                    ...
                                    <IconButton>
                                        <HiOutlineArrowCircleDown size="30px" color={colors.gray[100]}/>
                                    </IconButton>
                                </Box>
                        ...
                        <Box display="flex" flexDirection="column" position="sticky" top={0} zIndex={1} bgcolor={colors.gray[900]}>
                            <Box display="flex">
