            ...
            <Box display="flex" alignItems="center" justifyContent="space-between" margin="10px" bgcolor="white">
                ...
                <Box display="flex" gap="8px">
                    <Button disableRipple sx={{width:"150px", borderRadius:"20px", background:"lightgray", color:"black", "&:hover":{background:"gray", color:"white"}, "&:active":{background:"black", transition:"background 0.7s"}}}>
                        <Typography fontSize="14px" fontWeight="bold" sx={{textTransform:"none"}}>Explore Premium</Typography>
                    </Button>
                    <IconButton style={{background:"lightgray"}}>
                        <HiOutlineUserGroup size="20px" color="black"/>
                    </IconButton>
                    <img src={`../../assets/user.png`} style={{width:"36px", height:"36px", borderRadius:"50%"}}/>
                </Box>
            </Box>

            <Box display="flex" bgcolor="blueviolet" margin="10px" >
                <Box display="flex">
                    <img src={`../../assets/liked.png`} style={{width:"200px"}}/>
                </Box>
                <Box display="flex" flexDirection="column" margin="50px 20px 0 20px">
                    <Typography fontSize="15px" fontWeight="bold" color="white" >Playlist</Typography>
                    <Typography fontSize="60px" fontWeight="bold" color="white">Liked Songs</Typography>
                    <Box display="flex" alignItems="center">
                        <img src={`../../assets/user.png`} style={{width:"36px", height:"36px", borderRadius:"50%"}}/>
                        <Typography fontSize="15px" fontWeight="bold" color="white" marginLeft="10px">Midhun</Typography>
                        <Typography color="white" marginLeft="5px">|</Typography>
                        <Typography fontSize="15px" color="white" marginLeft="5px">10 songs</Typography>
                    </Box>
                </Box>
            </Box>
                ...
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Box display="flex" margin="8px" alignItems="center">
                        ...
                        <ButtonBase disableRipple sx={{background:"lightgray", borderRadius:"20px", margin:"8px"}}>
                            <IconButton type="button" sx={{p:1}} onClick={toggleSearch}>
                                <HiSearch size="20px" color="black" />
                            </IconButton>
